...
- 🧠 **Multi-layer Memory Architecture**: Four distinct memory types working together
- 🔍 **Semantic Search**: Vector-based retrieval using Weaviate
- 📝 **Automatic Reflection**: Generate insights from conversations
- 🔄 **Continuous Learning**: Update procedural rules based on feedback
- 🚀 **Multiple Interfaces**: CLI, API, and Python library
